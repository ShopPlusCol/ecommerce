...
export function OrderConfirmationClient() {
  ...
  React.useEffect(() => {
    // Lee el pedido de demostración desde sessionStorage tras el montaje.
    ...
    return (
      <div className="flex flex-col items-center gap-4 text-center">
        ...
        <p className="max-w-prose text-text-muted">
          ...
          pedidos por número llega en la siguiente fase.
        </p>
        <Link href="/catalogo">
    ...
    <div className="mx-auto flex max-w-2xl flex-col gap-6">
      <div className="flex flex-col items-center gap-3 text-center">
        ...
        <span className="rounded-full bg-info-soft px-3 py-1 text-xs font-medium text-info">
          Pedido de demostración — sin cobro real todavía
        </span>
      </div>
