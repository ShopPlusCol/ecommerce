...
import { categories, collectionProducts, collections, colorFamilies, productCategories, productMedia, products } from "@/infrastructure/db/schema";
...
export default async function ProductDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [[product], categoryRows, collectionRows, familyRows, assignedCategories, assignedCollections, media] = await Promise.all([
