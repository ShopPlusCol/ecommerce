...
export default async function AdminOrdersPage() {
  ...
  return <>
    ...
    {session.roles.includes("owner") ? <AdminDataResetForm title="Limpiar todos los pedidos" description="Elimina pedidos, pagos, envíos e historial relacionado; también libera todas las reservas de inventario. No elimina productos ni clientes." confirmation={resetConfirmation("orders")} action={clearOrdersAction} /> : null}
  </>;
}
